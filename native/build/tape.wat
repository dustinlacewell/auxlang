(module
 ...
 (global $assembly/tape/delay (mut i32) (i32.const 0))
 (global $assembly/tape/stateBuffer (mut i32) (i32.const 0))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34524))
 (memory $0 1)
 ...
 (data $13 (i32.const 1728) "\06\00\00\00 \00\00\00 \00\00\00 ")
 (data $13.1 (i32.const 1752) "$\19")
 (export "init" (func $assembly/tape/init))
 (export "process" (func $assembly/tape/process))
 (export "set_input" (func $assembly/tape/set_input))
 (export "set_time" (func $assembly/tape/set_time))
 (export "set_feedback" (func $assembly/tape/set_feedback))
 (export "set_mix" (func $assembly/tape/set_mix))
 (export "set_wow" (func $assembly/tape/set_wow))
 (export "set_flutter" (func $assembly/tape/set_flutter))
 (export "set_saturation" (func $assembly/tape/set_saturation))
 (export "set_tone" (func $assembly/tape/set_tone))
 (export "set_age" (func $assembly/tape/set_age))
 (export "clear" (func $assembly/tape/clear))
 (export "get_state_size" (func $assembly/tape/get_state_size))
 (export "alloc_state_buffer" (func $assembly/tape/alloc_state_buffer))
 (export "serialize_state" (func $assembly/tape/serialize_state))
 (export "deserialize_state" (func $assembly/tape/deserialize_state))
 ...
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $assembly/tape/delay
  local.tee $0
  if
   local.get $0
   call $~lib/rt/itcms/__visit
  end
  global.get $assembly/tape/stateBuffer
  local.tee $0
  if
   local.get $0
   call $~lib/rt/itcms/__visit
 ...
 (func $assembly/tape-delay/TapeDelay#set:buffer (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $1
 ...
 (func $assembly/tape/init (param $0 f32)
  local.get $0
  call $assembly/tape-delay/TapeDelay#constructor
  global.set $assembly/tape/delay
 )
 ...
 (func $assembly/tape/set_input (param $0 f32)
 )
 (func $assembly/tape/alloc_state_buffer (param $0 i32) (result i32)
  local.get $0
  call $~lib/staticarray/StaticArray<f32>#constructor
  global.set $assembly/tape/stateBuffer
  global.get $assembly/tape/stateBuffer
 )
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner0 $~lib/staticarray/StaticArray<f32> $invalid
       end
       return
      end
      return
 ...
 (func $assembly/tape-delay/TapeDelay#constructor (param $0 f32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  local.get $1
  i32.const 0
  call $assembly/tape-delay/TapeDelay#set:buffer
  global.get $~lib/memory/__stack_pointer
  local.get $1
  i32.store offset=4
  local.get $1
  ...
  i32.store offset=4
  local.get $1
  f32.const 2.0000000949949026e-03
  f32.store offset=28
  global.get $~lib/memory/__stack_pointer
  local.get $1
  i32.store offset=4
  local.get $1
  f32.const 3.000000142492354e-04
  f32.store offset=32
  global.get $~lib/memory/__stack_pointer
  local.get $1
  i32.store offset=4
 ...
 (func $assembly/tape/process (param $0 f32) (result f32)
  (local $1 f32)
  (local $2 i32)
  (local $3 i32)
  (local $4 f32)
 ...
 (func $assembly/tape/set_time (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_feedback (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_mix (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_wow (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_flutter (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_saturation (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_tone (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/set_age (param $0 f32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/get_state_size (result i32)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/tape/serialize_state (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $assembly/tape/deserialize_state
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
