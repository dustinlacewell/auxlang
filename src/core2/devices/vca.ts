/**
 * VCA - Voltage Controlled Amplifier with built-in ADSR envelope.
 * Multiplies input by an ADSR envelope triggered by gate.
 */

import { device } from "../device/device";

export const vca = device("vca", {
	inputs: { input: 0, gate: 0, attack: 0.01, decay: 0.1, sustain: 0.7, release: 0.3 },
	outputs: ["signal"],
	positionalArgs: ["gate", "attack", "decay", "sustain", "release"],
	defaultInput: "input",
